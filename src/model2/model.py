...
from src.model2.encoder import Encoder, Decoder
...
class PlSceneVAE(pl.LightningModule):
    def __init__(self, encoder_dim=1024, latent_dim=1024, beta=1):
        ...
        self.feed_fwd = nn.Sequential(nn.Linear(latent_dim, latent_dim * 2), nn.GELU(),
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.logger.experiment.add_image('Reconstruction', rec[0], dataformats='CHW',
